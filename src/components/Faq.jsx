...
//     answer: "Our AI instantly analyzes your uploaded medical reports and presents a simplified, easy-to-understand summary within seconds.",
//   },
//   {
//     question: "Is the AI report analysis accurate and reliable?",
//     answer: "Yes, our AI is trained on validated medical data and reviewed by healthcare professionals for high accuracy.",
//   },
//   {
//     question: "Can I upload images like X-rays or MRIs for analysis?",
//     answer: " Absolutely! We support image-based uploads for quick and intelligent diagnostics.",
//   },
//   {
//     question: "Can the chatbot diagnose diseases?",
//     answer: "While the chatbot offers suggestions and insights, we recommend consulting a licensed physician for formal diagnoses.",
//   },
//   {
//     question: "How can the AI help with my medical billing?",
//     answer: "Just upload your bill or insurance document, and our AI will break it down into understandable terms and spot errors or overcharges.",
//   },
//   {
//     question: "Is my medical data secure on this website?",
//     answer: "100%. We follow HIPAA-compliant practices to ensure your data is safe, encrypted, and never shared without consent.",
//   },
//   {
//     question: "Do I need a doctor to use this platform?",
//     answer: "We offer basic features for free, with premium options for advanced tools and personal consultations.",
//   },
// ];
...
//     <div className="2xl:max-w-6xl max-w-2xl mx-auto space-y-4">
...
//           <button
//             className="w-full flex justify-between items-center p-4 bg-gray-800 hover:bg-gray-700 text-white rounded-lg"
